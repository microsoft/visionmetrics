...
class AzureOpenAITextModelCategoricalScore(AzureOpenAITextModelCategoricalEvaluatorBase):
    ...
    def __init__(self, endpoint: str, deployment_name: str, system_message="", prompt_template="", temperature=0.0, max_tokens=50, positive_threshold=0.5, negative_value=''):
        self.system_message = system_message or """You are an expert evaluator of AI models. Follow the steps below:
...
Score: 0.0"""
        self.prompt_template = prompt_template or """Ground truth: <|target|>
